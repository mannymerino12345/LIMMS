...
class StaffLaboratoryController extends Controller
{
    public function index()
    {
        $laboratories = Laboratory::all(); // Fetch all laboratories
        return view('staff.staff_laboratory_management.staff_laboratory_table', compact('laboratories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $data->save();
        return redirect()->route('staff.laboratory.table')->with([
    ...
    public function edit($lab_id)
    {
        ...
        return view('staff.staff_laboratory_management.staff_laboratory_edit', compact('lab'));
    }
