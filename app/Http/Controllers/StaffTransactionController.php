...
class StaffTransactionController extends Controller
{
    public function request()
    {
        ...
        return view('staff.staff_transaction_management.staff_transaction_request', compact('transactions'));
    }
    ...
    public function approve($transaction_id)
    {
        ...
        return redirect()->route('staff.transaction.request')
    ...
    public function return(){
        ...
        return view('staff.staff_transaction_management.staff_transaction_return', compact('transactions'));
    }
    ...
    public function returned()
    {
        ...
        return view('staff.staff_transaction_management.staff_transaction_returned', compact('transactions'));
    }

    public function history(){
        $history = TransactionHistory::with([ 'user'])->get();

        return view('staff.staff_transaction_management.staff_transaction_history', compact('history'));
    }
}
