...
class AdminUserController extends Controller
{
    public function index()
    {
        ...
        if ($users->isEmpty()) {
            return view('admin.admin_account_management.admin_user_table', [
                'error' => 'No users found.',
            ]);
        }

        return view('admin.admin_account_management.admin_user_table', compact('users'));
    } // END METHOD
    ...
    public function edit($id)
    {
        ...
        return view('admin.admin_account_management.admin_user_edit', compact('user'));
    } // END METHOD
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.user.table')->with([
    ...
    public function show($id)
    {
        try {
            ...
            return view('admin.admin_account_management.admin_user_show', compact('user'));
        } catch (\Exception $e) {
