...
class StaffItemsController extends Controller
{
    public function index()
    {
        ...
        return view('staff.staff_items_management.staff_items_table', compact('items', 'categories', 'laboratories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('staff.items.table')->with('success', 'Item added successfully');
    }
     ...
     public function edit($item_id)
    {
        ...
        return view('staff.staff_items_management.staff_items_edit', compact('item', 'categories', 'laboratories'));
    }
    ...
    public function update(Request $request, $item_id)
    {
        ...
        return redirect()->route('staff.items.table')->with([   
    ...
    public function destroy($item_id)
    {
        ...
        return redirect()->route('staff.items.table')->with('success', 'Item deleted successfully');
    }
}
