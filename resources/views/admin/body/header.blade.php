                        ...
                        <ul class="header-notification-area">
                            ...
                            <li class="adomx-dropdown col-auto">
                                <a class="toggle" href="#">
                                    <span class="user">
                                <span class="avatar">
                                    <img src="{{(!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/profile.jpg')}}" alt="">
                                ...
                                <div class="adomx-dropdown-menu dropdown-menu-user">
                                    <div class="head">
                                        <h5 class="name"><a href="#">{{$profileData->name}}</a></h5>
                                        <a class="mail" href="#">{{$profileData->email}}</a>
                                    </div>
                                    <div class="body">
                                        <ul>
                                        ...
                                        <ul>
                                            <li><a href="{{url('admin/settings')}}"><i class="zmdi zmdi-settings"></i>Setting</a></li>
                                            <li><a href="{{url('admin/logout')}}"><i class="zmdi zmdi-lock-open"></i>Log out</a></li>
                                        </ul>
                                    </div>
                                </div>
