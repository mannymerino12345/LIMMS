                    ...
                    <div class="author-profile" style="position: absolute; bottom: 20px; left: 50%; transform: translateX(-50%);">
                        <div class="image " style="width: 150px; height: 150px;">
                            ...
                            <div style="display: flex; justify-content: center; align-items: center; height: 200px;">
                                <img src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/profile.jpg') }}" 
                                     alt="Profile Image" 
                                    ...
                                    <div class="row mbn-20">
                                        ...
                                        <div class="col-12 mb-20">
                                            <div class="col-sm-9 text-secondary">
                                                <img id="showImage"
                                                    src="{{ $profileData->photo ? url('upload/admin_images/'.$profileData->photo) : url('upload/profile.jpg') }}"
                                                    alt="Profile Image"
