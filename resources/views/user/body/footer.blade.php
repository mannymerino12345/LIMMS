                ...
                <div class="footer-content flex flex-grow">
                    <div class="widget-logo flex-grow">
                        <div class="logo-footer" id="logo-footer">
                            <a href="index.html" rel="home" class="main-logo" style="color: #def926;">
                                <i class="fas fa-flask" style="margin-right: 20px; color: #def926;"></i> 
                                <i class="fas fa-laptop" style="margin-right: 20px; color: #def926;"></i>  
                                <i class="fas fa-seedling" style="margin-right: 20px; color: #def926;"></i> 
                                <h2 style="color: #def926;">LIMMS</h2>
                            </a>
                        </div>
                    </div>
