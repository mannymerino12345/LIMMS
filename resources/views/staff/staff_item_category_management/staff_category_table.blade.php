                    ...
                    <table class="table footable"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('staff.category.edit', $category->category_id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="{{ route('staff.category.destroy', $category->category_id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
