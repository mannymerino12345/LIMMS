                    ...
                    <table class="table footable"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->days }}</td>
                                <td>
                                    <a href="{{ route('staff.items.edit', $item->item_id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="{{ route('staff.items.destroy', $item->item_id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
